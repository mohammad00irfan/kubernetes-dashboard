...
**Image:** `mohammad00irfan/kubernetes-dashboard:latest`

**Docker Hub:** [mohammad00irfan/kubernetes-dashboard](https://hub.docker.com/r/mohammad00irfan/kubernetes-dashboard)

**Commands:**
```bash
# Pull image
docker pull mohammad00irfan/kubernetes-dashboard:latest
